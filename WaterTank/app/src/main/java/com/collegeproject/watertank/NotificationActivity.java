...
public class NotificationActivity extends AppCompatActivity {
    ...
    class NOTIFICATION_TASK extends AsyncTask<RequestPackage, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Util.showprogress(NotificationActivity.this,"Loading Notifications");
        }
        ...
        protected void onPostExecute(String s) {
            ...
            Log.e("slsms", "onPostExecute: " + s);
            try {
                ArrayList<NotificationModel> notification = CustomParser.NotificationParse(s,NotificationActivity.this);
